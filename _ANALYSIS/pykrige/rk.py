...
class Krige(RegressorMixin, BaseEstimator):
    ...
    def __init__(self,
                 ...
                 variogram_model_parameters={"slope": 4, "nugget": 0},
                 nlags=6,
                 weight=False,
                 n_closest_points=10,
                 search_radius=500,
                 verbose=False,
                 variable_to_fit="estimates"):

        validate_method(method)
        self.variogram_model = variogram_model
        self.variogram_model_parameters = variogram_model_parameters
        ...
        self.method = method
        self.variable_to_fit = variable_to_fit
    ...
    def fit(self, x, y, *args, **kwargs):
        ...
        if self.method in threed_krige:
            self.model = krige_methods[self.method](
                ...
                variogram_parameters=self.variogram_model_parameters,
                nlags=self.nlags,
                weight=self.weight,
    ...
    def predict(self, x, *args, **kwargs):
        ...
        # print("predict", self.execute(points, *args, **kwargs))
        return self.execute(points, *args, **kwargs)[variable_to_fit_dict[self.variable_to_fit]]
